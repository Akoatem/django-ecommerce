...
# api_secret_key = 'FLWSECK_TEST-ae011af57f00d85a4ed95765be2a4fbc-X'
# tx_ref = 100360551
api_secret_key = 'FLWSECK_TEST-ae011af57f00d85a4ed95765be2a4fbc-X'
tx_ref = 100360551
amount = 1000
...
def generate_flutterwave_checksum(api_secret_key, tx_ref, amount, currency):
    # Concatenate parameters with pipe separator
    data_string = f"{api_secret_key}|{tx_ref}|{amount}|{currency}"
...
checksum = generate_flutterwave_checksum(api_secret_key, tx_ref, amount, currency)
print(checksum)
